        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="group space-y-4">
              ...
              <p className="text-gray-500 leading-relaxed">From our British roots to our expansion in the UAE, we offer an international career path in luxury design.</p>
            </div>
            <div className="group space-y-4">
              <div className="w-12 h-12 bg-[#F8F5EE] rounded-xl flex items-center justify-center text-[#D4AF37]">
                <Sparkles size={24} />
              </div>
              <h3 className="text-xl font-bold">The Dubai Vision</h3>
              <p className="text-gray-500 leading-relaxed">Be part of our flagship expansion into the world's most ambitious luxury interior market.</p>
            </div>
            <div className="group space-y-4">
              <div className="w-12 h-12 bg-[#F8F5EE] rounded-xl flex items-center justify-center text-[#D4AF37]">
                <Users size={24} />
          ...
          <form onSubmit={handleSubmit} className="space-y-6 bg-gray-50/50 p-8 md:p-12 rounded-3xl border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="phone" name="phone" type="tel" placeholder="+971 ..." className="bg-white border-gray-200 h-12 focus-visible:ring-[#D4AF37]" />
              </div>
            </div>
