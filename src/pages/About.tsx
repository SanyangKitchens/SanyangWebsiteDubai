          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 text-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-muted-foreground mt-2">Manufacturing Facilities</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="shadow-elegant border-border h-full">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  With 15+ manufacturing facilities and an integrated supply chain, we manage the entire process. This ensures unparalleled reliability, efficiency, and quality control.
                </p>
              </CardContent>
            </Card>
            {/* Card 3 */}
